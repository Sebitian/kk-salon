...
export const TEAM_CATEGORIES: TeamCategory[] = [
  {
    ...
    label: "Owners",
    members: [
      member("keeley", "Keeley", "Co-Founder", "keeley2_qc9whx"),
  ...
  },
  {
    ...
    members: [member("lane", "Lani", "Front Desk", "lane_frontdesk_z6fzxu")],
  },
  {
    id: "need",
    label: "Need",
    members: [
      member("connie", "P5", "Assistant", "0G3A7333_ls2949"),
      member("connie", "P4", "Assistant", "0G3A7343_wsdvvg"),
      member("connie", "P3", "Assistant", "0G3A7362_bidhe6"),
      member("connie", "Dylan", "Assistant", "0G3A7362_bidhe6"),
      member("connie", "P2", "Assistant", "0G3A7005_o0kwyi"),
      member("p1", "P1", "Assistant", "0G3A7377_cviz1i"),
    ],
  },
  {
    id: "assistants",
  ...
  },
  {
    ...
    members: [
      ...
      member("joanna", "Joanna", "Colorist / Stylist", "joanna_colorist_stylist_plqlks"),
  ...
  },
  {
    ...
    label: "Spa",
    members: [
      member("natalie", "Natalie", "Estethician / Makeup Artist", "natalie_estethician_y7eehm"),
      ...
      member("carol-marie", "Carol Marie", "Estethician", "carol_marrie_esthetician_rrcawz"),
      member("marie", "Marie", "Estethician", "marie_estethician_xrhmc9"),
      member("matt", "Matt", "Massage Therapist", "matt_massage_therapist_qtxfzl"),
      member("maria", "Maria", "Estethician / Massage Therapist", "maria_kelley_esthetician_massage_therapist_er7ey7"),
    ],
  },
]
