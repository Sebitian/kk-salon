...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "We offer salon services (haircuts, color, treatments, retexturizing, nails, waxing, lashes + brows, and makeup), spa services (facials, advanced facial treatments, body treatments, body wraps, and massage therapies), and weddings / events (bridal hair and makeup with in-salon and on-location options).",
  },
  {
...
export const metadata: Metadata = {
  title:
    "Kossof Salon Spa FAQ | Salon, Spa, and weddings / events in Lincolnshire, IL",
  description:
    "Frequently asked questions about Kossof Salon Spa in Lincolnshire, IL, including booking, consultations, cancellation policy, salon services, spa services, weddings / events, and business hours.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Answers to common questions about appointments, policies, and salon, spa, and weddings / events at Kossof Salon Spa.",
    type: "website",
    locale: "en_US",
        ...
        <section className="relative py-20 mb-12 pt-40 sm:pt-44">
          ...
          <div className="container-custom relative z-10">
            ...
            <p className="text-white text-center text-lg max-w-3xl mx-auto">
              ...
              weddings / events menus in Lincolnshire, Illinois.
            </p>
          </div>
        </section>
