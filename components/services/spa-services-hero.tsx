      ...
      <div className="container mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="text-salon-brown/80 text-base lg:text-lg leading-relaxed max-w-3xl mx-auto italic font-light pt-2">
            Indulge in our curated collection of spa experiences—from rejuvenating facials and
            luxurious body treatments to therapeutic massage therapies—designed to restore,
