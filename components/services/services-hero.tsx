      ...
      <div className="container mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="text-salon-brown/80 text-base lg:text-lg leading-relaxed max-w-3xl mx-auto italic font-light pt-2">
            Explore our full menu of elevated salon and spa services—from precision cuts and custom color to nail care and
            relaxing treatments—delivered with top-notch hospitality and exceptional service.
          </p>
        </div>
      </div>
    </section>
